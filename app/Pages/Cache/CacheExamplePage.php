...
<section class="rounded-2xl border border-slate-800 bg-slate-900/70 p-8 shadow-2xl shadow-slate-950/30">
    <span
    ...
    <article class="mt-8 overflow-hidden rounded-2xl border border-slate-800 bg-slate-950/60">
            ...
            <table class="min-w-full divide-y divide-slate-800 text-sm text-slate-300">
                ...
                <tbody class="divide-y divide-slate-800">
                    <tr class="bg-slate-950/30">
                        ...
                        <td class="px-5 py-4 align-top text-rose-300">No</td>
                        <td class="px-5 py-4 align-top text-emerald-300">Si</td>
                        <td class="px-5 py-4 align-top text-amber-300">Si, sobre esa URL</td>
                    ...
                    <tr class="bg-slate-950/10">
                        ...
                        <td class="px-5 py-4 align-top text-rose-300">No</td>
                        <td class="px-5 py-4 align-top text-rose-300">No</td>
                        <td class="px-5 py-4 align-top text-amber-300">Puede limpiar la previa</td>
                    ...
                    <tr class="bg-slate-950/30">
                        ...
                        <td class="px-5 py-4 align-top text-rose-300">No, en esa visita</td>
                        <td class="px-5 py-4 align-top text-emerald-300">Si</td>
                        <td class="px-5 py-4 align-top text-emerald-300">Si</td>
    ...
    <div class="mt-8 grid gap-4 lg:grid-cols-2">
        ...
        <article class="rounded-2xl border border-slate-800 bg-slate-950/60 p-5">
            <div class="flex items-start justify-between gap-4">
                ...
                <code class="rounded bg-slate-900 px-2 py-1 text-xs text-cyan-300">{{ $example['cache'] }}</code>
            </div>
            ...
            <div class="mt-5 flex flex-wrap gap-3">
                <a href="{{ $example['href'] }}" volt:navigate volt:prefetch="none" volt:cache="{{ $example['cache'] }}"
                    class="inline-flex items-center rounded-lg border border-cyan-400/30 bg-slate-950/70 px-4 py-2 text-sm font-medium text-cyan-200 transition hover:border-cyan-300 hover:text-white">
    ...
    <article class="mt-8 rounded-2xl border border-slate-800 bg-slate-950/60 p-5">
        ...
        <div class="mt-6 grid gap-4 md:grid-cols-2 xl:grid-cols-3">
            ...
            <article data-volt-hook-card="{{ $eventName }}"
                class="flex h-full flex-col rounded-xl border border-slate-800 bg-slate-900/70 p-4">
                ...
                <div class="mt-4 grid grid-cols-2 gap-3 text-xs">
                    <div class="rounded-lg border border-slate-800 bg-slate-950/70 p-3">
                        ...
                        <strong data-volt-hook-count class="mt-1 block text-lg text-white">0</strong>
                    </div>
                    <div class="rounded-lg border border-slate-800 bg-slate-950/70 p-3">
                        <span class="block text-slate-500">Ultima vez</span>
                        <strong data-volt-hook-last class="mt-1 block text-sm text-white">-</strong>
                    </div>
                </div>
        ...
        <div class="mt-6">
            ...
            <ol data-volt-hook-log data-volt-hook-log-filter="cache-only" class="mt-4 grid gap-3"></ol>
        </div>
    </article>
    ...
    <article class="mt-8 rounded-2xl border border-slate-800 bg-slate-950/60 p-5">
        ...
        <div class="mt-4 flex flex-wrap gap-3">
            ...
            <button type="button" data-volt-cache-invalidate-all="true"
                class="inline-flex items-center rounded-lg border border-rose-500/30 bg-rose-950/20 px-4 py-2 text-sm font-medium text-rose-200 transition hover:border-rose-400 hover:text-white">
